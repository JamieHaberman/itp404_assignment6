    ...
    actions: {
      newArtists: function newArtists(e) {
        ...
        promise.then(function (response) {
          ...
          // OR
          //
          var newArtists = artists.concat(response['new']);
...
define('crud-in-class/controllers/new', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    actions: {
      createSong: function createSong(e) {
        var _this = this;
...
define('crud-in-class/routes/artists/new', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model(params) {
      var artistID = params.id;
      var url = 'http://itp-api.herokuapp.com/api/artists/' + artistID;
...
define("crud-in-class/templates/artists", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["content", "artist.name", ["loc", [null, [8, 12], [8, 27]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })();
      ...
      return {
        ...
        statements: [["block", "link-to", ["artists.artist", ["get", "artist.id", ["loc", [null, [7, 38], [7, 47]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [7, 10], [9, 22]]]], ["block", "link-to", ["artists.new", ["get", "artist.id", ["loc", [null, [12, 35], [12, 44]]], 0, 0, 0, 0]], [], 1, null, ["loc", [null, [12, 10], [14, 22]]]]],
        locals: ["artist"],
    ...
    return {
      ...
      statements: [["block", "each", [["get", "model.artists", ["loc", [null, [5, 14], [5, 27]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [5, 6], [16, 15]]]], ["content", "outlet", ["loc", [null, [20, 6], [20, 16]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
...
define("crud-in-class/templates/artists/new", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["attribute", "onsubmit", ["subexpr", "action", ["newArtists"], [], ["loc", [null, [null, null], [2, 38]]], 0, 0], 0, 0, 0, 0], ["inline", "input", [], ["type", "text", "value", ["subexpr", "@mut", [["get", "artistName", ["loc", [null, [3, 34], [3, 44]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [3, 8], [3, 46]]], 0, 0], ["content", "outlet", ["loc", [null, [8, 0], [8, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: []
    };
  })());
